...
export default class BmoAvatar extends React.PureComponent {
  setAvatarColor() {
  ...
  render() {
    if (!this.props.user.name && !this.props.user.avatar) {
      return (
        <View style={[styles.avatarStyle, styles.avatarTransparent, this.props.avatarStyle]} accessibilityTraits="image" />
      );
    }
    if (this.props.user.avatar) {
      return (
        <TouchableOpacity  disabled={!this.props.onPress} onPress={() => {
