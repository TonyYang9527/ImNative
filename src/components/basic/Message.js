...
export default class Message extends React.PureComponent {
    ...
    getInnerComponentProps() {
        ...
        return { ...props, isSameUser, isSameDay, };
    }
    ...
    render() {
        ...
        return (
            <View>
                {this.renderDay()}
                {this.props.currentMessage.system ? (this.renderSystemMessage()) :
                    (
                        <View style={[  styles[this.props.position].container,  { marginBottom: sameUser ? 2 : 10 },
